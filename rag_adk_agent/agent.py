...
def sync_agent(): 
    ...
    return LlmAgent(
        ...
        instruction=(
            ...
            "The 'path' property in the graph nodes is relative path, and you should use it directly. Don't try to craft an absolute path yourself, "
            ...
            "you should first get the 'id' property of the node, then use its id to get the node's source code with a MCP tool."
            "## Note 3:"
            "For content search, you can use 'starts with' or 'contains' to search for relevant code or summary information; or,"
            ...
            "CALL db.index.vector.queryNodes($vector_index_name, 5, $query_embeddings) YIELD node, score RETURN node.name, node.summary, score"
