...
class NodeParserMixin:
    ...
    def _process_generic_node(self, node, file_name):
        ...
        # We import SourceSpan here to avoid circular dependencies if any
        from .worker import SourceSpan
    ...
    def _process_type_alias_node(self, node, file_name):
        ...
        from .worker import TypeAliasSpan
